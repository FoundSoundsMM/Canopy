#!/bin/sh
# headless compile/load check for lib/Engine_Canopy.sc against SuperCollider
...
EXT_DIR="$HOME/Library/Application Support/SuperCollider/Extensions/Canopy"
mkdir -p "$EXT_DIR"
ln -sf "$DIR/../lib/Engine_Canopy.sc" "$EXT_DIR/Engine_Canopy.sc"
